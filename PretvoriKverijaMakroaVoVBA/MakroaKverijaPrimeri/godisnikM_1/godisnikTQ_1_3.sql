...
FROM TabelaVnes2 INNER JOIN TabelaAdresar ON (TabelaVnes2.OTSEK = TabelaAdresar.SIFRAOTSEK) AND (TabelaVnes2.EVS = TabelaAdresar.EDINICASOS) AND (TabelaVnes2.MATBR = TabelaAdresar.MATBR)
