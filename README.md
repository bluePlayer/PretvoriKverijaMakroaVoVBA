...
- Вклучително, сега се додава помошна функција DodajTestTabeli() која кога би се повикала во ВБА кодот, на пример на кликање на копче, би се створиле локални табели со наставка _TEST со истите податоци и дизајн на серверските табели. Ова го олеснува тестирањето на апликацијата, така што ќе имаме тест табели за вежбање и разни намени. 
Исто така тест табелите ќе можат да се избришат на копче со помош на функцијата brishiMegjuTabeli() која се додава автоматски во главниот ВБА модул. 
...
Во случајов, вториот дел, претворање на макроа и кверија во ВБА модули со динамички ескуел код не успеа затоа што во папката на макрото Macro5 не постоеше ВБА модул со име, Macro5.bas. Со извезување на истиот, ќе се створи нов модул со име Macro5_SQL.bas кој ќе ги содржи кверијата како динамички ескуел, притоа, е модул кој ги содржи само кверијата кои се повикуваат во истоименото макро во Акцес, и се наоѓа во своја соодветна папка.
...
End Function
```
додека модулот кој ќе се створи во папката Macro5, Macro5_SQL.bas изгледа вака:
```vb
...
On Error GoTo Macro5_Err
    ...
    DoCmd.SetWarnings False
    DoCmd.RunSQL Macro5_SQL.Regioni_0(TabelaVnes , TabelaNasMesta)
    DoCmd.RunSQL Macro5_SQL.Regioni_01(TabelaVnes , TabelaNasMesta)
    DoCmd.RunSQL Macro5_SQL.Regioni(TabelaVnes , TabelaNasMesta)
...
# Недостатоци
- Во Акцес постои вид на квери кое што се вика „Кростаб квери“ ("Crosstab Query"). Во главно квери кое што се користи за пивотирање на табели, редиците стануваат колони, колоните стануваат редици. Оваа алатка за сега не работи со Кростаб квери односно клучниот збор Transform. 
- Некои корисни видеа:
[![Crosstab Query with multiple Value Fields](https://img.youtube.com/vi/XfNGUAldalY&t=25s/0.jpg)](https://www.youtube.com/watch?v=XfNGUAldalY&t=25s)
[![Crosstab Query Results to a Table](https://img.youtube.com/vi/zXnzeJ5g_CE/0.jpg)](https://www.youtube.com/watch?v=zXnzeJ5g_CE)
